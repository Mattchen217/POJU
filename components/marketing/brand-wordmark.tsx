...
const effectClass =
  "font-primary font-semibold uppercase tracking-[0.12em] text-[#f4f4f8] antialiased [text-shadow:0_0_22px_rgba(255,255,255,0.16),0_1px_3px_rgba(0,0,0,0.5)]";

export type BrandWordmarkSize = keyof typeof sizeClass;

/** 与页脚「POJU LIFE」一致：字重、字距、浅色字 + 轻微光晕 */
