...
const STRUCTURAL: GlossaryConcept[] = [
  ...
  ce("流年", ["Liu Nian", "Fleeting Year"], sg("Transit", "岁环", "Tránsito", "Transit", "Transit", "The temporal climate you're in—it shapes mood and external pressure like weather, without predicting specific events.", "你此刻所处的时间气候——它像天气一样影响你的状态与外部压力，但不预测具体事件。", "El clima temporal en el que estás—moldea ánimo y presión externa como el clima, sin predecir eventos.", "Le climat temporel dans lequel vous êtes—il façonne humeur et pression externe comme la météo, sans prédire d'événements.", "Das Zeitklima, in dem du bist—formt Stimmung und äußeren Druck wie Wetter, ohne Ereignisse vorherzusagen.")),
