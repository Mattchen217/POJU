...
const STRUCTURAL: GlossaryConcept[] = [
  ...
  ce("大运", ["Da Yun", "Luck Pillar", "Major Luck"], sg("life phase", "人生阶段", "fase vital", "phase de vie", "Lebensphase", "Longer chapter you are moving through.", "正在经历的较长章节。", "Capítulo largo.", "Chapitre long.", "Langes Kapitel.")),
  ce("流年", ["Liu Nian", "Fleeting Year"], sg("year's energy", "流年能量", "energía del año", "énergie de l'année", "Jahresenergie", "Annual window on your life phase.", "叠在大运上的年度窗口。", "Ventana anual.", "Fenêtre annuelle.", "Jahresfenster.")),
