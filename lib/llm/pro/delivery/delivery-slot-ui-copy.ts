...
const BY_LOCALE: Record<Exclude<DeliveryLocaleBucket, "de">, Omit<DeliverySlotUiCopy, "week" | "evidenceFor" | "evidenceWhy"> & {
  ...
  en: {
    ...
    means: "Actions",
    angle: "Angle",
    angleGloss: "One reusable angle: grasp the play, then act",
  ...
  es: {
    ...
    means: "Acciones",
    angle: "Ángulo",
    angleGloss: "Un ángulo reutilizable: entiende la jugada, luego actúa",
    ...
    dimensionGloss:
      "Dimensiones de estrategia (visual / espacio / ritmo / recurso)",
  ...
  fr: {
    ...
    means: "Actions",
    angle: "Angle",
    angleGloss: "Un angle réutilisable : comprenez le jeu, puis agissez",
    ...
    dimensionGloss:
      "Dimensions de stratégie (visuel / espace / rythme / ressource)",
