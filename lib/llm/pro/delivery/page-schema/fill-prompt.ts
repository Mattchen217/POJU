...
禁在用户可见字段写:玄学、命理、八字、五行、用神、忌神、风水、运势、东方维、色/向/时字面清单、吉方/凶方、属相。

# 推荐维名菜单(有关才写,不强制凑满6;可同构高管咨询命名)
1) 视觉心理 · 权威气场与色彩阻尼
2) 空间心理 · 专注场域与采光阻尼
3) 生物节律 · 昼夜认知峰谷时窗
4) 战略周期 · 阶段节奏与时间窗口
...
- strategy/means/page_title 同样守禁词表——不得在正文解释「这对应八字用神/五行」;依据层另写。
- **硬禁 P3 复读 / 换皮**:邮件话术、授权清单、日历/Slack工具、谈判二选一、战绩夹、现金缓冲。协同/行业维只写定位→场域动作。
- 节律/色彩/朝向/恢复句须能挂 pack 真算,**只写与本页问题/期望相关的维**;编不出就薄写并标明不足,禁止假精确。
- 依据层(evidence / bazi_basis)另走闭集打标链路——本页 body 仍白话合规。

${titleRules(tag, "点出场域/节律/精力主题", "副题点非对称杠杆(合规咨询用语)")}`;
    case "thirty_day":
