...
const MEANS_LAYER_TAIL_RE =
  /求财|技术转化|技术输出|不可急进|急进|节奏杠杆|精力配比|沟通协作|一层第一步|开口谈|先兼职|兼职试水|兼职节奏|转全职|全职跳入|全职投入|全职加码|冒进全职|全职风险|不宜冒进|不宜.{0,8}(?:加码|冒进)|须待.{0,16}窗口|宜以.{0,20}姿态|宜守结构节奏|守结构节奏|待水旺|本维兑现|靠近补给|远离过耗|借势|侧翼借势|话语权|画饼|赢得尊重|实际贡献|协议明确|以柔克刚|技术价值|加重筹码|争取权益|利益争取|守住能量|合伙关系|结构性摩擦|天然受限|乐于(?:付出)?技术|思虑过多|思虑保守|加重思虑|行动保守|保守求稳|易思虑|借.{0,8}(?:贵人|将星).{0,6}之|之(?:谋略|魄力|和解|洞察|回旋|周密)/;
