      ...
      backup_toolkit: {
        ...
        angles: [
          ...
          },
          {
            name: "现金跑道",
            strategy:
              "辅路第三维是公开动作前的硬闸：先钉死本案收集给出的 burn 缓冲目标日，达标前冻结新的英雄式 ownership，也不发离职/转岗公开宣布。缓冲不是怂，是避免情绪性跳槽把止损做成二次受伤。",
            exact_script:
              "我设了缓冲目标：账户可覆盖本案陈述的 runway 之前，不做公开离职/转岗宣布。本周只冻结新的英雄式 ownership，并把缓冲进度钉在日历上。",
            means: [
              "按本案收集算出 burn，日历钉缓冲达标检查日；达标前零公开宣布",
              "冻结新英雄式 ownership，已接事项标出可移交项",
            ],
            hard_metrics: ["公开宣布前须达到本案陈述的 runway"],
            chart_anchors: ["用神·水", "日主强弱"],
          },
        ],
      },
      ...
      dimensions: [
        {
          name: "视觉心理 · 权威气场与色彩阻尼",
          strategy:
            "就「保结果话语权、降一线消耗」这件事：用稳定深色做视觉权威阻尼，关键开口与赞助可见场合穿/佩这些色，帮你稳住输出感，而不是再靠硬扛刷存在感。",
          means: [
            "关键会与书面沟通日，主色用本案 color_anchors 给出的外层色（与个人色彩锚一致）",
        ...
        },
        {
          name: "空间心理 · 专注场域与采光阻尼",
          strategy:
            "远程操盘要的是可持续输出：工位与开口朝向优先落在高适配侧，减少在耗尽朝向里开硬谈——这是专注场域与采光阻尼，不是另开科学谈判剧本。",
          means: [
            "深工与关键开口优先坐在已标为高适配的一侧（如东南/正东桌角，以真算优选为准）",
        ...
        },
        {
          name: "生物节律 · 昼夜认知峰谷时窗",
          strategy:
            "把推进这件事的关键动作排进更匹配的认知高峰时窗；谷底段只做整理、不做硬推进——用昼夜节律护「可持续」期望。",
          means: [
        ...
        },
        {
          name: "战略周期 · 阶段节奏与时间窗口",
          strategy:
            "对照当前阶段窗口：近窗更利「结构改造与远程操盘定型」，不适合再加一线冲锋债；更远的窗口才适合扩大对外开拓——阶段定性指导节奏，不报绝对吉凶日期。",
          means: [
        ...
        },
        {
          ...
          strategy:
            "把互补型伙伴当组织杠杆：用冷静·适应气质的人做缓冲与转圜，而不是再自己硬顶一线火情——服务「结果权留下、冲锋权拆开」。",
          means: [
            "关键节点优先拉一位冷静/适应型搭档做前置对齐，而不是你独自硬谈",
...
> = {
  ...
  metaphysics_action: [
    ...
    "视觉心理：权威气场与色彩阻尼，稳住输出感而非硬冲。",
    "空间心理：高适配侧工位/开口；避耗尽朝向硬谈。",
    "生物节律：关键推进排午前清档；谷底夜只归档。",
    "战略周期：近窗定远程结构，后窗再开拓——阶段定性非绝对日期。",
    "精力管理：补清润节奏，避一线纠缠耗尽。",
    "组织杠杆：互补型缓冲转圜；禁复读科学页邮件/授权手段。",
  ],
  thirty_day: [
  ...
  risk_guard: [
    "红灯1：赞助沉默对齐睡眠回流，不是泛泛「你累了」。",
    "红灯2：深夜消息回流时硬谈必须停机。",
    "特有坑：情绪再辩却不发框架。",
    "切辅开关绑定两盏红灯。",
    "防护1：无书面取舍不接 ownership。",
    "防护2：睡眠底板不可烧。",
  ],
  signals_close: [
