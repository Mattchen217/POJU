...
- **跨页去重铁律**:「养根 / 小森林 / 宜守 / 向内积累 / 冬天养根」类主隐喻**【全报告最多出现一次】**——通常只允许落在 energy_base 或 macro_cycle 其中一页。其他页必须给**新维度**(十神图谱、神煞阶段、大运窗口、科学动作、环境调频、红线、信号),禁止换皮复读同一劝导。
- science_action:具体步骤/第一步/可能的坑;metaphysics_action:推荐方位/高频时段/视觉锚点/协同人群(禁吉凶/属相/风水/玄学字面)。
...
- thirty_day:按周解读双轨动作;表内容只放在 thirty_day_table;【禁止】在 body 吐 ASCII 甘特或 markdown 周表。
