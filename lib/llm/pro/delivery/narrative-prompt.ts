...
`
      : primaryKey === "metaphysics_action"
        ? `
# 本页专规 · 场域调频方案(每项=策略+行动 · 支付网关合规包装 · 禁复读 P3)
- 锚定用户【问题+期望】;内容可保留穿搭色/朝向/时段/避耗——【禁止】邮件/授权/日历/Slack/谈判话术等科学职场手段(归 P3)。
- 须从上游多维 + metaphysics_pack **多维生长**,通常 **3–5 项**,每项 title+strategy+methods;有关才写、无关不硬凑。
- 用户可见包装域:环境心理 / 视觉心理 / 生物节律 / 高管精力管理 / 组织杠杆。
- **推荐维名菜单**(有关才写):
  1) 视觉心理 · 权威气场与色彩阻尼
  2) 空间心理 · 专注场域与采光阻尼
  3) 生物节律 · 昼夜认知峰谷时窗
  ...
  5) 精力管理 · 认知恢复与损耗隔离
  6) 组织杠杆 · 非对称协同与缓冲转圜
- 策略必须说清「对【他这件事情】为何成立」;禁吉凶/属相/风水/用神/八字/五行/东方维字面;禁只有行动没有策略。
`
        : "";
