...
`
      : primaryKey === "metaphysics_action"
        ? `
# 本页专规 · 东方行动方案(每项=策略+手段 · 纯东方维 · 禁复读 P3)
- 锚定用户【问题+期望】;本页只写东方多维行动杠杆——【禁止】邮件/授权/日历/Slack/谈判话术等科学职场手段(归 P3)。
- 须从上游多维 + metaphysics_pack **多维生长**,通常 **3–5 项**,每项 title+strategy+methods;有关才写、无关不硬凑。
- 建议覆盖(有料才写):
  1) 色彩/着装锚定 · 关键场合穿/佩什么色
  2) 方位/空间朝向 · 去哪一侧、工位/开口怎么摆
  3) 精力高频时段 · 什么时辰段更利推进这件事
  4) 大运/阶段年窗 · 哪几年更利事业推进 vs 宜守(阶段定性,禁绝对吉凶日期)
  5) 用神补/忌神避 · 补什么场域气质、避开什么消耗
  6) 行业主题 / 互补型协同方向(可分项)
- 策略必须说清「对【他这件事情】为何成立」;禁吉凶/属相/风水字面;禁只有手段没有策略。
`
        : "";
