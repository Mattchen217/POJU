...
- **跨页去重铁律**:「养根 / 小森林 / 宜守 / 向内积累 / 冬天养根」类主隐喻**【全报告最多出现一次】**——只允许落在 foundation。其他页必须给**新维度**(论证支点/科学药方/东方药方/红线/信号),禁止换皮复读同一劝导。
- science_action:【科学一套·策略+手段】策略=边界/发力/易栽/切换;手段=资源精力配比、沟通协作原则、节奏杠杆、一层「第一步怎么起」示意。arguments 通常≥3,须同时看见策略维与手段维(或等价结构);禁「你可以这样开口说」整段剧本;禁只有策略没有手段;禁「谁都适用」(删依据还成立=重写)。metaphysics_action:【东方一套·策略+手段】策略=以用神喜忌补什么/避什么/怎么借势(对齐主路);手段=方位/高频时段/视觉锚点/协同人群——每条说清「为什么对【你】有用」;禁只有手段清单没有策略;禁吉凶/属相/风水字面。
- direct_answer:正面直答 + 一句主路径 + 一句为什么;只给结论头,不铺论证;【禁止】重画仪表盘数字表。
- foundation:论证「为什么卡」——按论证需要放底座料(能量/十神/神煞长生/周期),内部小标题分块,收敛到「所以你卡在这」;仪表盘真分解读;禁逐月预测;「养根」类隐喻只此页一次。【禁】输出完整月路线图/前中后10天清单/谈判话术(那些归 thirty_day / science_action);rhythm 最多一句阶段定位。
- thirty_day:按周解读双轨(科学药方动作+东方药方动作);节奏松紧对应当前大运/阶段(宜守蓄力 vs 可推进),勿把方案平均切4周;【禁】搬 science_action 谈判逐字稿进周表;表内容只放在 thirty_day_table;【禁止】在 body 吐 ASCII 甘特或 markdown 周表。
