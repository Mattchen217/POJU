...

{
  ...
  "命理双视角": {
    "命理看此事": "480-820 字【依据·命盘，不复述问题】。日主/大运/流年/用神/五行（允许术语，就近用大白话解释）逐项展开——此人对此事的天然倾向、亮点与盲点。直接分析，不复述问题。",
    "签文看此事": "480-820 字【依据·签象，不复述问题】。Glyph 文原型对此事照出的意象/典故（可引用 1-2 句签诗原文，抽象化；用 Glyph 指代，禁 sign/lot）",
