...
- 这盘没算出的神煞——包括你训练里认识的任何其他神煞（空亡/国印/将星/月德/天德/劫煞/元辰/六秀日/阴差阳错/金舆/十恶大败/学堂/词馆…）——对【这个盘】不存在。写一个都算编造，会被审计拦截、整份重写。
...
你训练里认识的其它神煞（天喜/红鸾/空亡/国印/将星/月德/天德/劫煞/元辰/金舆/十恶大败/学堂/词馆…）对【这个盘】不存在，写了就是错。
...
- 关系少是正常的。不要为了"丰富"去补；不够就靠十神/用神/喜忌/强弱/大运说话。`;
  }
  if (compact) {
    return `【本盘动态关系 · 硬约束】
...
关系为空是完全正常的——靠十神/用神/喜忌/强弱/大运说话即可。写任何关系词都会被拦截、整份重写。`;
}
...
靠本命关系/十神/用神/大运说话即可；写任何未列出的流年关系词都会被拦截。`;
}
