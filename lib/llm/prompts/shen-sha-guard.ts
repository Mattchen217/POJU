...
- 神煞为空是完全正常的——靠十神/用神/喜忌/强弱/纪元与岁环/藏干说话即可。写任何神煞名都会被拦截、整份重写。`;
}
...
神煞为空是正常的——靠十神/用神/喜忌/强弱/纪元与岁环说话即可，别为"丰富"硬补。`;
}
...
- 关系少是正常的。不要为了"丰富"去补；不够就靠十神/用神/喜忌/强弱/纪元与岁环说话。`;
  }
  if (compact) {
    return `【本盘动态关系 · 硬约束】
...
关系为空是完全正常的——靠十神/用神/喜忌/强弱/纪元与岁环说话即可。写任何关系词都会被拦截、整份重写。`;
}
...
靠本命关系/十神/用神/纪元与岁环说话即可；写任何未列出的流年关系词都会被拦截。`;
}
