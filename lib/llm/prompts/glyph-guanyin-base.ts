...
✓ **强制翻译表**（像 MBTI / 荣格，可中英双语括号）：
- 日主乙木 → 「柔韧且敏感的适应型人格架构 (Resilient & Adaptive Matrix)」
- 大运（10 年）→ 「当前 10 年生命周期 (Major Life Cycle)」
- 流年（本年）→ 「当前年度周期 (Current Annual Cycle)」
- 食神 / 七杀 → 「表达型智慧 与 外部规则压力的动力学」
- 喜用水金 → 「需补充：沉静的智慧与决断力」
- 喜土金 → 「你需要补充的能量：稳定感与清晰的结构判断」
- 忌火土 → 「需警惕：急躁与固执」
- 贵人 → 「外部助力 / 扶持你的人 / 关键支持者」
- 贵人显 → 「外部支持增强的阶段」
- 贵人扶持 → 「来自外界的助力」

⚠️ **五行字（金木水火土）绝不作为「能量元素」出现在输出**——必须翻译成心理学描述（稳定 / 智慧 / 决断 / 急躁 / 固执等）。
中文可保留东方意境词（静水、滋养、涵养），但**意境词 ≠ 术语**——绝不出现干支 / 十神 / 命理框架词 / 五行元素字 / 贵人。
