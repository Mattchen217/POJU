...
3. ### 此刻真正要看清的
   ...
   【禁止】预告下一气泡(Call B)要问的收集清单——无论有没有「比如」:
     · 禁枚举「安全垫/咨询方向/反对声音/积蓄/市场/家人/每周几小时」等具体对齐项;
     · 禁「你的A有多厚、你的B有多清晰、反对声音背后…」并列预告;
     · 最多一句「走法还要和你的实际情况对齐」收束——不问具体问题、不列清单。
...
⑦ 第三节是否仍预告「安全垫/方向/反对声」等收集清单,或泄漏内部骨架词?有→删清单,只留分岔+「需现实对齐」一句。
