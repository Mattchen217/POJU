...
export const REPORT_BLUEPRINT: readonly ReportPage[] = [
  ...
  },
  {
    ...
    writes:
      "方位适配/朝向、色彩锚定、行业属性方向、日内高效时段、协同人群方位特质。合规包装（空间效能/时机窗口/协同伙伴，禁吉凶/风水/生肖）。",
  ...
  },
  {
    ...
    purpose: "给我一张能贴墙、照着走的东西——掌控感。",
    writes:
      "4周甘特：每周（科学动作+环境调频动作）、可勾选、可打印；主路径排期 + 辅路径切换点。按周不按天。",
    chart_inputs: ["rhythm_frame", "primary_path", "backup_path"],
    input_role: "needs_reality",
  ...
  },
  {
    ...
    purpose: "帮我别踩坑——安心感。",
    writes: "这30天【别做】什么、【警惕】哪些信号、身体报警信号。用'别做X'清单形式。",
