...
4. 正式用户自动交付链路行为不变。
5. **分步验收**：点跑对照参考尺 [Delivery-Lab-30步分步验收标准.md](./Delivery-Lab-30步分步验收标准.md) + 内容尺 [六页交付内容质量验收标准.md](./六页交付内容质量验收标准.md)；**踩坑/签字/回归**仍写活文档 [delivery-lab-分步验收标准.md](./delivery-lab-分步验收标准.md)（用途不变）。成书 Canonical：[pivot-八页交付验收标准.md](./pivot-八页交付验收标准.md)。
