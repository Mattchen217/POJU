...
| **节奏** | **跟清晰度走**：清晰包约 2 轮收口进总结确认；模糊/多议题包多轮引导至用户说出或点选「先解决什么」+ 主期望，再收口 |
...
| **期望够用线** | `wants` = 针对主楔的结果**方向/状态**即够；**不是**方案形态。方向一出口即可收口 |
| **手段边界** | 手段是命理**产出**，第1段**不向用户收集**；「了解想到哪」本分，「追怎么做到」越界 |
| **禁止** | 替用户敲定主战场后收口；多议题并列当主问题收口；为方案具体化继续追；清空已填 wants；心理创伤式深挖；复读用户原话；灌映射全表；展开命盘分析 |
