...
## 记下的点（派工 · 2026-09-24 attempt #2 · 有条件过）

**来源**：science_action.assign · gate PASSED · attempt #2。处境尾巴已去掉。人审有条件过。

4. **主张仍偏长 / 多环塞一句（续 #2）**  
   主0 等仍把身强+运岁+半合+通关写进同一句，近专写厚度。  
   **后续**：同 #2，派工宜一句一切入；完整链留给 write。

5. **摘录与主张运岁层不完全同层（类别 · 同 P2 #12）**  
   主0 主张含流年丙午·寅午半合，摘录只贴「当前大运：壬寅」；辅2 主张含丙午冲壬，摘录只贴半合行。结构主张本身合格。  
   **后续**：摘录优先覆盖主张主承重层（运+岁+半合则至少摘到半合/流年行之一）。

6. **「比肩争夺」略近表象（类别）**  
   辅0「比肩争夺」扣比肩夺财结构可成立，但偏表象动词。  
   **后续**：派工宜写「比肩克财 / 忌土争用」一类结构向；争夺感留给 fill。

## 明确先不动

- 不回滚 assign #6 / write #23 / 本次 assign #2。  
- 不加个案黑名单。  
