...
// --- plan build: six pages, mutual exclusion ---
{
  ...
  assert.ok(plan.pages.foundation.must_use.includes("situation_conclusion"));
  assert.ok(plan.pages.foundation.must_use.includes("key_crossroads"));
  assert.ok(plan.pages.foundation.must_use.includes("question_expectation"));
  ...
  assert.ok(plan.pages.science_action.must_use.includes("question_expectation"));
  assert.ok(plan.pages.science_action.must_use.includes("modern_action_frames"));
